...
@Schema(description = "Request payload for creating production records in batch.")
public class CreateBatchProductionRequest {
    ...
    public CreateBatchProductionRequest(String batchId, LocalDate date, Double quantity, String userId) {
