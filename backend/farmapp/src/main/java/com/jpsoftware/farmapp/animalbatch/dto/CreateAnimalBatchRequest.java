...
@Schema(description = "Request payload for creating an animal batch.")
public class CreateAnimalBatchRequest {

    @NotBlank(message = "name must not be blank")
    @Schema(description = "Batch name.", example = "Lote das novilhas")
    private String name;
    ...
    public CreateAnimalBatchRequest() {
    }

    public CreateAnimalBatchRequest(String name, List<String> animalIds) {
        this.name = name;
