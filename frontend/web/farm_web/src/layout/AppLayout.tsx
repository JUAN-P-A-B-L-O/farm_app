      ...
      <div className="app-layout__content">
        <header className="app-layout__mobile-bar">
          <button
            ...
            aria-controls="app-layout-sidebar-navigation"
            onClick={() => setIsMobileNavigationOpen((current) => !current)}
          >
            {t('layout.openNavigation')}
          </button>

          <div className="app-layout__mobile-context">
            <span className="app-layout__mobile-context-label">
              {activeNavigationItem ? t(activeNavigationItem.labelKey) : t('layout.farmLabel')}
            </span>
            <strong className="app-layout__mobile-context-value">
              {selectedFarm?.name ?? t('layout.selectFarm')}
            </strong>
          </div>
        </header>
